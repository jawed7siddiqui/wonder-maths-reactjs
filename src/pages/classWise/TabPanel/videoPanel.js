    ...
    return (
        <Grid container rowSpacing={4.5} columnSpacing={2.75}>
            ...
            <Grid item xs={3} sm={3} md={3} lg={2}>
                <Typography variant="h5">Select video list</Typography>
                <FormControl style={{ minWidth: '150px' }}>
                    <Select labelId="demo-simple-select-label" id="demo-simple-select" value={age} onChange={handleChange}>
                        <MenuItem value={0}>Select</MenuItem>
                        <MenuItem value={10}>Video 1: Linear Function</MenuItem>
                        <MenuItem value={20}>Video 2: Linear Function</MenuItem>
                        <MenuItem value={30}>Video 3: Linear Function</MenuItem>
                    </Select>
                </FormControl>
            </Grid>
            {/* row 2 */}
